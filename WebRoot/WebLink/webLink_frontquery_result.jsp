...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="col-md-12 wow fadeInLeft">
			<ul class="breadcrumb">
				...
				<a class="pull-right"
					href="<%=basePath %>WebLink/webLink_frontAdd.jsp"
					style="display: none;">添加友情链接</a>
			</ul>
			<div class="row">
				<%
				/*计算起始序号*/
			...
			%>
				<div class="col-md-3 bottom15" <%=clearLeft %>>
					<a
						href="<%=basePath  %>WebLink/<%=webLink.getLinkId() %>/frontshow"><img
						class="img-responsive"
						src="<%=basePath%><%=webLink.getWebLogo()%>" /></a>
					<div class="showFields">
						...
						<a class="btn btn-primary top5"
							href="<%=basePath %>WebLink/<%=webLink.getLinkId() %>/frontshow">详情</a>
						<a class="btn btn-primary top5"
							onclick="webLinkEdit('<%=webLink.getLinkId() %>');"
							style="display: none;">修改</a> <a class="btn btn-primary top5"
							onclick="webLinkDelete('<%=webLink.getLinkId() %>');"
	...
	<div id="webLinkEditDialog" class="modal fade" tabindex="-1"
		role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-edit"></i>&nbsp;友情链接信息编辑
					</h4>
				</div>
				<div class="modal-body" style="height: 450px; overflow: scroll;">
					<form class="form-horizontal" name="webLinkEditForm"
						id="webLinkEditForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="webLink_linkId_edit" class="col-md-3 text-right">记录id:</label>
							<div class="col-md-9">
								<input type="text" id="webLink_linkId_edit"
									name="webLink.linkId" class="form-control"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="webLink_webName_edit"
									name="webLink.webName" class="form-control"
									placeholder="请输入网站名称">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="webLink_webAddress_edit"
									name="webLink.webAddress" class="form-control"
									placeholder="请输入网站地址">
							</div>
						</div>
					</form>
					<style>
#webLinkEditForm .form-group {
	margin-bottom: 5px;
}
</style>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="ajaxWebLinkModify();">提交</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
