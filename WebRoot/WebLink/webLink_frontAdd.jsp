...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="col-md-12 wow fadeInLeft">
			...
			<div class="row">
				<div class="col-md-10">
					<form class="form-horizontal" name="webLinkAddForm"
						id="webLinkAddForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="webLink_webName" class="col-md-2 text-right">网站名称:</label>
							<div class="col-md-8">
								<input type="text" id="webLink_webName" name="webLink.webName"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="webLink_webAddress"
									name="webLink.webAddress" class="form-control"
									placeholder="请输入网站地址">
							</div>
						</div>
						<div class="form-group">
							<span class="col-md-2""></span> <span onclick="ajaxWebLinkAdd();"
								class="btn btn-primary bottom5 top5">添加</span>
						</div>
						<style>
#webLinkAddForm .form-group {
	margin: 5px;
}
</style>
					</form>
