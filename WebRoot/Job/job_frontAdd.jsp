				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation"><a
							href="<%=basePath %>Job/frontlist">职位列表</a></li>
						<li role="presentation" class="active"><a href="#jobAdd"
							aria-controls="jobAdd" role="tab" data-toggle="tab">添加职位</a></li>
					</ul>
					<!-- Tab panes -->
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane" id="jobList"></div>
						<div role="tabpanel" class="tab-pane active" id="jobAdd">
							<form class="form-horizontal" name="jobAddForm" id="jobAddForm"
								enctype="multipart/form-data" method="post" class="mar_t15">
								<div class="form-group">
									<label for="job_jobTypeObj_jobTypeId"
										class="col-md-2 text-right">职位类别:</label>
									<div class="col-md-8">
										<select id="job_jobTypeObj_jobTypeId"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_jobName" name="job.jobName"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea name="job.jobDesc" id="job_jobDesc"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_salary" name="job.salary"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_zprs" name="job.zprs"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_xlyq" name="job.xlyq"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_yxqx" name="job.yxqx"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_gzqy" name="job.gzqy"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_gzdz" name="job.gzdz"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" id="job_viewNum" name="job.viewNum"
											class="form-control" placeholder="请输入浏览次数">
									</div>
								</div>
								<div class="form-group">
									<label for="job_companyObj_companyUserName"
										class="col-md-2 text-right">发布企业:</label>
									<div class="col-md-8">
										<select id="job_companyObj_companyUserName"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<div id="job_addTimeDiv"
											class="input-group date job_addTime col-md-12"
											data-link-field="job_addTime">
											<input class="form-control" id="job_addTime"
								...
								<div class="form-group">
									<span class="col-md-2""></span> <span onclick="ajaxJobAdd();"
										class="btn btn-primary bottom5 top5">添加</span>
								</div>
							</form>
							<style>
#jobAddForm .form-group {
	margin: 10px;
}
</style>
						</div>
