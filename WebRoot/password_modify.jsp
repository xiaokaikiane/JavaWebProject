	...
	<TABLE align="center" cellSpacing=0 cellPadding=0 width="80%" border=0>
		<TBODY>
			<TR>
				...
				<form action="<%=basePath %>changePassword" method="post"
						name="form1" target="submitFrame">
						<table width='100%' cellspacing='1' cellpadding='3'
							...
							<tr bgcolor='#FFFFFF'>
								<td colspan="4" align="center"><input type='submit'
									name='button' value='修改'> &nbsp;&nbsp;</td>
							</tr>

						</table>
					</form> <iframe name="submitFrame" frameborder="0" scrolling="yes"
						width="100%" height="300px"></iframe></TD>
			</TR>
		</TBODY>
	</TABLE>
</BODY>
