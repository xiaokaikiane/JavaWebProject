...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="col-md-12 wow fadeInLeft">
			...
			<div class="row">
				<div class="col-md-10">
					<form class="form-horizontal" name="userInfoAddForm"
						id="userInfoAddForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="userInfo_password"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="userInfo_gender" name="userInfo.gender"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div id="userInfo_birthDateDiv"
									class="input-group date userInfo_birthDate col-md-12"
									data-link-field="userInfo_birthDate"
									data-link-format="yyyy-mm-dd">
									<input class="form-control" id="userInfo_birthDate"
						...
						<div class="form-group">
							<label for="userInfo_xl" class="col-md-2 text-right">学历:</label>
							<div class="col-md-8">
								<input type="text" id="userInfo_xl" name="userInfo.xl"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="userInfo_email" name="userInfo.email"
						...
						<div class="form-group">
							<label for="userInfo_jianliFile" class="col-md-2 text-right">简历文件:</label>
							<div class="col-md-8">
								<a id="userInfo_jianliFileImg" border="0px"></a><br /> <input
						...
						<div class="form-group">
							<label for="userInfo_smrzzl" class="col-md-2 text-right">实名认证资料:</label>
							<div class="col-md-8">
								<a id="userInfo_smrzzlImg" border="0px"></a><br /> <input
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="userInfo_shzt" name="userInfo.shzt"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div id="userInfo_regTimeDiv"
									class="input-group date userInfo_regTime col-md-12"
									data-link-field="userInfo_regTime">
									<input class="form-control" id="userInfo_regTime"
						...
						<div class="form-group">
							<span class="col-md-2""></span> <span
								onclick="ajaxUserInfoAdd();"
								class="btn btn-primary bottom5 top5">添加</span>
						</div>
						<style>
#userInfoAddForm .form-group {
	margin: 5px;
}
</style>
					</form>
	...
	<script type="text/javascript"
		src="<%=basePath %>plugins/bootstrap-datetimepicker.min.js"
		charset="UTF-8"></script>
	<script type="text/javascript"
		src="<%=basePath %>plugins/locales/bootstrap-datetimepicker.zh-CN.js"
		charset="UTF-8"></script>
	<script>
