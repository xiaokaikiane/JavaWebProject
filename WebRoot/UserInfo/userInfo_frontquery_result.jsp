...
<%
    ...
    String xl = (String)request.getAttribute("xl"); //学历查询关键字
	...
	<div class="container">
			...
			%>
				<div class="col-md-3 bottom15" <%=clearLeft %>>
					...
					<div class="showFields">
						...
						<div class="field">
							简历文件:<%=userInfo.getJianliFile().equals("")?"暂无文件":"<a href='" + basePath + userInfo.getJianliFile() + "' target='_blank'>" + userInfo.getJianliFile() + "</a>"%>
						</div>
						<div class="field">
							实名认证资料:<%=userInfo.getSmrzzl().equals("")?"暂无文件":"<a href='" + basePath + userInfo.getSmrzzl() + "' target='_blank'>" + userInfo.getSmrzzl() + "</a>"%>
						</div>
						<div class="field">
						...
						<a class="btn btn-primary top5"
							onclick="userInfoEdit('<%=userInfo.getUser_name() %>');"
							style="display: none;">修改</a> <a class="btn btn-primary top5"
							onclick="userInfoDelete('<%=userInfo.getUser_name() %>');"
		...
		<div class="col-md-3 wow fadeInRight">
			...
			<form name="userInfoQueryForm" id="userInfoQueryForm"
				...
				<div class="form-group">
					<label for="birthDate">出生日期:</label> <input type="text"
						id="birthDate" name="birthDate" class="form-control"
						placeholder="请选择出生日期" value="<%=birthDate %>"
						onclick="SelectDate(this,'yyyy-MM-dd')" />
				</div>
				<div class="form-group">
					<label for="xl">学历:</label> <input type="text" id="xl" name="xl"
						value="<%=xl %>" class="form-control" placeholder="请输入学历">
				</div>
				<div class="form-group">
				...
				<div class="modal-body" style="height: 450px; overflow: scroll;">
					<form class="form-horizontal" name="userInfoEditForm"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="userInfo_gender_edit"
									name="userInfo.gender" class="form-control" placeholder="请输入性别">
							</div>
						</div>
						<div class="form-group">
							<label for="userInfo_birthDate_edit" class="col-md-3 text-right">出生日期:</label>
							<div class="col-md-9">
								<div class="input-group date userInfo_birthDate_edit col-md-12"
									data-link-field="userInfo_birthDate_edit"
									data-link-format="yyyy-mm-dd">
									<input class="form-control" id="userInfo_birthDate_edit"
										name="userInfo.birthDate" size="16" type="text" value=""
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<img class="img-responsive" id="userInfo_userPhotoImg"
									...
									id="userInfo_userPhoto" name="userInfo.userPhoto" /> <input
									id="userPhotoFile" name="userPhotoFile" type="file" size="50" />
							</div>
						</div>
						<div class="form-group">
							<label for="userInfo_xl_edit" class="col-md-3 text-right">学历:</label>
							<div class="col-md-9">
								<input type="text" id="userInfo_xl_edit" name="userInfo.xl"
									class="form-control" placeholder="请输入学历">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="userInfo_email_edit"
									name="userInfo.email" class="form-control" placeholder="请输入邮箱">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="userInfo_jianliFile_edit" class="col-md-3 text-right">简历文件:</label>
							<div class="col-md-9">
								<a id="userInfo_jianliFileA" target="_blank"></a><br /> <input
									type="hidden" id="userInfo_jianliFile"
									name="userInfo.jianliFile" /> <input id="jianliFileFile"
									name="jianliFileFile" type="file" size="50" />
							</div>
						</div>
						<div class="form-group">
							<label for="userInfo_smrzzl_edit" class="col-md-3 text-right">实名认证资料:</label>
							<div class="col-md-9">
								<a id="userInfo_smrzzlA" target="_blank"></a><br /> <input
									type="hidden" id="userInfo_smrzzl" name="userInfo.smrzzl" /> <input
									id="smrzzlFile" name="smrzzlFile" type="file" size="50" />
							</div>
						</div>
						<div class="form-group">
							<label for="userInfo_shzt_edit" class="col-md-3 text-right">审核状态:</label>
							<div class="col-md-9">
								<input type="text" id="userInfo_shzt_edit" name="userInfo.shzt"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group date userInfo_regTime_edit col-md-12"
									data-link-field="userInfo_regTime_edit">
									<input class="form-control" id="userInfo_regTime_edit"
										name="userInfo.regTime" size="16" type="text" value=""
										placeholder="请选择注册时间" readonly> <span
										class="input-group-addon"><span
										class="glyphicon glyphicon-remove"></span></span> <span
										class="input-group-addon"><span
										class="glyphicon glyphicon-calendar"></span></span>
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_jianliFileA").text(userInfo.jianliFile);
				$("#userInfo_jianliFileA").attr("href", basePath +　userInfo.jianliFile);
				$("#userInfo_smrzzl").val(userInfo.smrzzl);
				$("#userInfo_smrzzlA").text(userInfo.smrzzl);
				$("#userInfo_smrzzlA").attr("href", basePath +　userInfo.smrzzl);
