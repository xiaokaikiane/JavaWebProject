			...
			<div class="row">
				<form class="form-horizontal" name="userInfoEditForm"
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" id="userInfo_email_edit" name="userInfo.email"
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<a id="userInfo_jianliFileImg" width="200px" border="0px"></a><br />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<a id="userInfo_smrzzlImg" width="200px" border="0px"></a><br />
					...
					<div class="form-group">
						<span class="col-md-3""></span> <span
							onclick="ajaxUserInfoModify();"
							class="btn btn-primary bottom5 top5">修改</span>
					</div>
				</form>
				<style>
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_jianliFileA").val(userInfo.jianliFile);
				$("#userInfo_jianliFileA").attr("href", basePath +　userInfo.jianliFile);
				$("#userInfo_smrzzlA").val(userInfo.smrzzl);
