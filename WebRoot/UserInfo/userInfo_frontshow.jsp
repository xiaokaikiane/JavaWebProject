...
<body style="margin-top: 70px;">
	...
	<div class="container">
		...
		<div class="row bottom15">
			...
			<div class="col-md-10 col-xs-6">
				<img class="img-responsive"
					src="<%=basePath %><%=userInfo.getUserPhoto() %>" border="0px" />
			</div>
		</div>
		<div class="row bottom15">
			<div class="col-md-2 col-xs-4 text-right bold">学历:</div>
			<div class="col-md-10 col-xs-6"><%=userInfo.getXl()%></div>
		</div>
		<div class="row bottom15">
		...
		<div class="row bottom15">
			<div class="col-md-2 col-xs-4 text-right bold">简历文件:</div>
			<div class="col-md-10 col-xs-6">
				<a href="<%=basePath%><%=userInfo.getJianliFile()%>" target="_blank"><%=userInfo.getJianliFile()%></a>
			</div>
		</div>
		<div class="row bottom15">
			<div class="col-md-2 col-xs-4 text-right bold">实名认证资料:</div>
			<div class="col-md-10 col-xs-6">
				<a href="<%=basePath%><%=userInfo.getSmrzzl()%>" target="_blank"><%=userInfo.getSmrzzl()%></a>
			</div>
		</div>
		<div class="row bottom15">
