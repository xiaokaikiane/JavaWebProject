...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="col-md-9 wow fadeInLeft">
			<ul class="breadcrumb">
				...
				<a class="pull-right"
					href="<%=basePath %>Company/company_frontAdd.jsp"
					style="display: none;">添加企业</a>
			</ul>
			<div class="row">
				<%
				/*计算起始序号*/
			...
			%>
				<div class="col-md-3 bottom15" <%=clearLeft %>>
					<a
						href="<%=basePath  %>Company/<%=company.getCompanyUserName() %>/frontshow"><img
						class="img-responsive" src="<%=basePath%><%=company.getYyzz()%>" /></a>
					<div class="showFields">
						...
						<a class="btn btn-primary top5"
							href="<%=basePath %>Company/<%=company.getCompanyUserName() %>/frontshow">详情</a>
						<a class="btn btn-primary top5"
							onclick="companyEdit('<%=company.getCompanyUserName() %>');"
							style="display: none;">修改</a> <a class="btn btn-primary top5"
							onclick="companyDelete('<%=company.getCompanyUserName() %>');"
		...
		<div class="col-md-3 wow fadeInRight">
			...
			<form name="companyQueryForm" id="companyQueryForm"
				action="<%=basePath %>Company/frontlist" class="mar_t15"
				method="post">
				<div class="form-group">
					<label for="qyjb">信用级别:</label> <input type="text" id="qyjb"
						name="qyjb" value="<%=qyjb %>" class="form-control"
						placeholder="请输入信用级别">
				</div>
				<div class="form-group">
					<label for="companyName">企业名称:</label> <input type="text"
						id="companyName" name="companyName" value="<%=companyName %>"
						class="form-control" placeholder="请输入企业名称">
				</div>
				<div class="form-group">
					<label for="gszch">工商注册号:</label> <input type="text" id="gszch"
						name="gszch" value="<%=gszch %>" class="form-control"
						placeholder="请输入工商注册号">
				</div>
				<div class="form-group">
					<label for="gsxz">公司性质:</label> <input type="text" id="gsxz"
						name="gsxz" value="<%=gsxz %>" class="form-control"
						placeholder="请输入公司性质">
				</div>
				<div class="form-group">
					<label for="gsgm">公司规模:</label> <input type="text" id="gsgm"
						name="gsgm" value="<%=gsgm %>" class="form-control"
						placeholder="请输入公司规模">
				</div>
				<div class="form-group">
					<label for="gghy">公司行业:</label> <input type="text" id="gghy"
						name="gghy" value="<%=gghy %>" class="form-control"
						placeholder="请输入公司行业">
				</div>
				<div class="form-group">
					<label for="lxr">联系人:</label> <input type="text" id="lxr"
						name="lxr" value="<%=lxr %>" class="form-control"
						placeholder="请输入联系人">
				</div>
				<div class="form-group">
					<label for="lxdh">联系电话:</label> <input type="text" id="lxdh"
						name="lxdh" value="<%=lxdh %>" class="form-control"
						placeholder="请输入联系电话">
				</div>
				<div class="form-group">
					<label for="shzt">审核状态:</label> <input type="text" id="shzt"
						name="shzt" value="<%=shzt %>" class="form-control"
						placeholder="请输入审核状态">
				</div>
	...
	<div id="companyEditDialog" class="modal fade" tabindex="-1"
		role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-edit"></i>&nbsp;企业信息编辑
					</h4>
				</div>
				<div class="modal-body" style="height: 450px; overflow: scroll;">
					<form class="form-horizontal" name="companyEditForm"
						id="companyEditForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="company_companyUserName_edit"
								class="col-md-3 text-right">企业用户名:</label>
							<div class="col-md-9">
								<input type="text" id="company_companyUserName_edit"
									name="company.companyUserName" class="form-control"
									placeholder="请输入企业用户名" readOnly>
							</div>
						</div>
						<div class="form-group">
							<label for="company_password_edit" class="col-md-3 text-right">登录密码:</label>
							<div class="col-md-9">
								<input type="text" id="company_password_edit"
									name="company.password" class="form-control"
									placeholder="请输入登录密码">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="company_qyjb_edit" name="company.qyjb"
									class="form-control" placeholder="请输入信用级别">
							</div>
						</div>
						<div class="form-group">
							<label for="company_companyName_edit" class="col-md-3 text-right">企业名称:</label>
							<div class="col-md-9">
								<input type="text" id="company_companyName_edit"
									name="company.companyName" class="form-control"
									placeholder="请输入企业名称">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="company_gszch_edit" name="company.gszch"
									class="form-control" placeholder="请输入工商注册号">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								<input type="hidden" id="company_yyzz" name="company.yyzz" /> <input
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="company_gsxz_edit" name="company.gsxz"
									class="form-control" placeholder="请输入公司性质">
							</div>
						</div>
						<div class="form-group">
							<label for="company_gsgm_edit" class="col-md-3 text-right">公司规模:</label>
							<div class="col-md-9">
								<input type="text" id="company_gsgm_edit" name="company.gsgm"
									class="form-control" placeholder="请输入公司规模">
							</div>
						</div>
						<div class="form-group">
							<label for="company_gghy_edit" class="col-md-3 text-right">公司行业:</label>
							<div class="col-md-9">
								<input type="text" id="company_gghy_edit" name="company.gghy"
									class="form-control" placeholder="请输入公司行业">
							</div>
						</div>
						<div class="form-group">
							<label for="company_lxr_edit" class="col-md-3 text-right">联系人:</label>
							<div class="col-md-9">
								<input type="text" id="company_lxr_edit" name="company.lxr"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="company_lxdh_edit" name="company.lxdh"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="company_address_edit"
									name="company.address" class="form-control"
									placeholder="请输入公司地址">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="company_shzt_edit" name="company.shzt"
									class="form-control" placeholder="请输入审核状态">
							</div>
						</div>
					</form>
					<style>
#companyEditForm .form-group {
	margin-bottom: 5px;
}
</style>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="ajaxCompanyModify();">提交</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
