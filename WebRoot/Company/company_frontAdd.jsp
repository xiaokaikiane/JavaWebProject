			...
			<div class="row">
				<div class="col-md-10">
					<form class="form-horizontal" name="companyAddForm"
						id="companyAddForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="company_companyUserName" class="col-md-2 text-right">企业用户名:</label>
							<div class="col-md-8">
								<input type="text" id="company_companyUserName"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_password" name="company.password"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_qyjb" name="company.qyjb"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_gszch" name="company.gszch"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_gsxz" name="company.gsxz"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_gsgm" name="company.gsgm"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_gghy" name="company.gghy"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_lxr" name="company.lxr"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_lxdh" name="company.lxdh"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea name="company.companyDesc" id="company_companyDesc"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="company_shzt" name="company.shzt"
									class="form-control" placeholder="请输入审核状态">
							</div>
						</div>
						<div class="form-group">
							<span class="col-md-2""></span> <span onclick="ajaxCompanyAdd();"
								class="btn btn-primary bottom5 top5">添加</span>
						</div>
						<style>
#companyAddForm .form-group {
	margin: 5px;
}
</style>
					</form>
