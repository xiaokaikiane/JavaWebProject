...
<body>
	...
	<div id="login">
		<p>
			登录帐号：<input type="text" id="manager" class="textbox">
		</p>
		<p>
			登录密码：<input type="password" id="password" class="textbox">
		</p>
		<p style="display: none;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;身份： <select name="identify"
				id="identify">
		...
		<p>
			<font color="#999">记住账号</font> <input id="saveid" type="checkbox"
				onclick="savePaw();" />
		</p>
