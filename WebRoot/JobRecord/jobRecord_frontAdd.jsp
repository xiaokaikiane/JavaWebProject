				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation"><a
							href="<%=basePath %>JobRecord/frontlist">兼职记录列表</a></li>
						<li role="presentation" class="active"><a
							href="#jobRecordAdd" aria-controls="jobRecordAdd" role="tab"
							data-toggle="tab">添加兼职记录</a></li>
					</ul>
					<!-- Tab panes -->
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane" id="jobRecordList"></div>
						<div role="tabpanel" class="tab-pane active" id="jobRecordAdd">
							<form class="form-horizontal" name="jobRecordAddForm"
								id="jobRecordAddForm" enctype="multipart/form-data"
								method="post" class="mar_t15">
								<div class="form-group">
									<label for="jobRecord_title" class="col-md-2 text-right">标题:</label>
									<div class="col-md-8">
										<input type="text" id="jobRecord_title" name="jobRecord.title"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea name="jobRecord.content" id="jobRecord_content"
											style="width: 100%; height: 500px;"></textarea>
									</div>
								</div>
								<div class="form-group">
									<label for="jobRecord_userObj_user_name"
										class="col-md-2 text-right">记录人:</label>
									<div class="col-md-8">
										<select id="jobRecord_userObj_user_name"
											name="jobRecord.userObj.user_name" class="form-control">
										</select>
									</div>
								</div>
								<div class="form-group">
									<label for="jobRecord_recordDateDiv"
										class="col-md-2 text-right">记录时间:</label>
									<div class="col-md-8">
										<div id="jobRecord_recordDateDiv"
											class="input-group date jobRecord_recordDate col-md-12"
											data-link-field="jobRecord_recordDate">
											<input class="form-control" id="jobRecord_recordDate"
								...
								<div class="form-group">
									<span class="col-md-2""></span> <span
										onclick="ajaxJobRecordAdd();"
										class="btn btn-primary bottom5 top5">添加</span>
								</div>
							</form>
							<style>
#jobRecordAddForm .form-group {
	margin: 10px;
}
</style>
						</div>
