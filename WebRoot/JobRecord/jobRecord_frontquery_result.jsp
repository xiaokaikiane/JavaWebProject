...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="row">
				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a
							href="#jobRecordListPanel" aria-controls="jobRecordListPanel"
							role="tab" data-toggle="tab">兼职记录列表</a></li>
						<li role="presentation"><a
							href="<%=basePath %>JobRecord/jobRecord_frontAdd.jsp"
							style="display: none;">添加兼职记录</a></li>
					</ul>
					<!-- Tab panes -->
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active"
							id="jobRecordListPanel">
							<div class="row">
										...
										<table class="table table-condensed table-hover">
 										...
 										%>
											<tr>
												...
												<td><a
													href="<%=basePath  %>JobRecord/<%=jobRecord.getRecordId() %>/frontshow"><i
														class="fa fa-info"></i>&nbsp;查看</a>&nbsp; <a href="#"
													onclick="jobRecordEdit('<%=jobRecord.getRecordId() %>');"
													style="display: none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
													<a href="#"
													onclick="jobRecordDelete('<%=jobRecord.getRecordId() %>');"
			...
			<div class="col-md-3 wow fadeInRight">
				...
				<form name="jobRecordQueryForm" id="jobRecordQueryForm"
					action="<%=basePath %>JobRecord/frontlist" class="mar_t15"
					method="post">
					<div class="form-group">
						<label for="title">标题:</label> <input type="text" id="title"
							name="title" value="<%=title %>" class="form-control"
							placeholder="请输入标题">
					</div>
					...
					<div class="form-group">
						<label for="userObj_user_name">记录人：</label> <select
					...
					<div class="form-group">
						<label for="recordDate">记录时间:</label> <input type="text"
							id="recordDate" name="recordDate" class="form-control"
							placeholder="请选择记录时间" value="<%=recordDate %>"
	...
	<div id="jobRecordEditDialog" class="modal fade" tabindex="-1"
		role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-edit"></i>&nbsp;兼职记录信息编辑
					</h4>
				</div>
				<div class="modal-body" style="height: 450px; overflow: scroll;">
					<form class="form-horizontal" name="jobRecordEditForm"
						id="jobRecordEditForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="jobRecord_recordId_edit" class="col-md-3 text-right">记录id:</label>
							<div class="col-md-9">
								<input type="text" id="jobRecord_recordId_edit"
									name="jobRecord.recordId" class="form-control"
									placeholder="请输入记录id" readOnly>
							</div>
						</div>
						<div class="form-group">
							<label for="jobRecord_title_edit" class="col-md-3 text-right">标题:</label>
							<div class="col-md-9">
								<input type="text" id="jobRecord_title_edit"
									name="jobRecord.title" class="form-control" placeholder="请输入标题">
							</div>
						</div>
						<div class="form-group">
							<label for="jobRecord_content_edit" class="col-md-3 text-right">内容:</label>
							<div class="col-md-9">
								<textarea name="jobRecord.content" id="jobRecord_content_edit"
									style="width: 100%; height: 500px;"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="jobRecord_userObj_user_name_edit"
								class="col-md-3 text-right">记录人:</label>
							<div class="col-md-9">
								<select id="jobRecord_userObj_user_name_edit"
									name="jobRecord.userObj.user_name" class="form-control">
								</select>
							</div>
						</div>
						<div class="form-group">
							<label for="jobRecord_recordDate_edit"
								class="col-md-3 text-right">记录时间:</label>
							<div class="col-md-9">
								<div
									class="input-group date jobRecord_recordDate_edit col-md-12"
									data-link-field="jobRecord_recordDate_edit">
									<input class="form-control" id="jobRecord_recordDate_edit"
										name="jobRecord.recordDate" size="16" type="text" value=""
										placeholder="请选择记录时间" readonly> <span
	...
	margin-bottom: 5px;
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="ajaxJobRecordModify();">提交</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
