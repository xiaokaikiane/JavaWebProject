...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="row">
				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a
							href="#deliveryListPanel" aria-controls="deliveryListPanel"
							role="tab" data-toggle="tab">简历投递列表</a></li>
						<li role="presentation"><a
							href="<%=basePath %>Delivery/delivery_frontAdd.jsp"
							style="display: none;">添加简历投递</a></li>
					</ul>
					<!-- Tab panes -->
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active"
							id="deliveryListPanel">
							<div class="row">
										...
										<table class="table table-condensed table-hover">
 										...
 										%>
											<tr>
												...
												<td><a
													href="<%=basePath  %>Delivery/<%=delivery.getDeliveryId() %>/frontshow"><i
														class="fa fa-info"></i>&nbsp;查看</a>&nbsp; <a href="#"
													onclick="deliveryEdit('<%=delivery.getDeliveryId() %>');"
													style="display: none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
													<a href="#"
													onclick="deliveryDelete('<%=delivery.getDeliveryId() %>');"
			...
			<div class="col-md-3 wow fadeInRight">
				...
				<form name="deliveryQueryForm" id="deliveryQueryForm"
					action="<%=basePath %>Delivery/frontlist" class="mar_t15"
					method="post">
					<div class="form-group">
						<label for="jobObj_jobId">应聘职位：</label> <select id="jobObj_jobId"
							name="jobObj.jobId" class="form-control">
					...
					<div class="form-group">
						<label for="userObj_user_name">应聘人：</label> <select
							id="userObj_user_name" name="userObj.user_name"
							class="form-control">
					...
					<div class="form-group">
						<label for="deliveryTime">投递时间:</label> <input type="text"
							id="deliveryTime" name="deliveryTime" class="form-control"
							placeholder="请选择投递时间" value="<%=deliveryTime %>"
							onclick="SelectDate(this,'yyyy-MM-dd')" />
					</div>
					<div class="form-group">
						<label for="handleTime">处理时间:</label> <input type="text"
							id="handleTime" name="handleTime" class="form-control"
							placeholder="请选择处理时间" value="<%=handleTime %>"
							onclick="SelectDate(this,'yyyy-MM-dd')" />
					</div>
					<div class="form-group">
						<label for="clzt">处理状态:</label> <input type="text" id="clzt"
							name="clzt" value="<%=clzt %>" class="form-control"
							placeholder="请输入处理状态">
					</div>
	...
	<div id="deliveryEditDialog" class="modal fade" tabindex="-1"
		role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-edit"></i>&nbsp;简历投递信息编辑
					</h4>
				</div>
				<div class="modal-body" style="height: 450px; overflow: scroll;">
					<form class="form-horizontal" name="deliveryEditForm"
						id="deliveryEditForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="delivery_deliveryId_edit" class="col-md-3 text-right">投递id:</label>
							<div class="col-md-9">
								<input type="text" id="delivery_deliveryId_edit"
									name="delivery.deliveryId" class="form-control"
									placeholder="请输入投递id" readOnly>
							</div>
						</div>
						<div class="form-group">
							<label for="delivery_jobObj_jobId_edit"
								class="col-md-3 text-right">应聘职位:</label>
							<div class="col-md-9">
								<select id="delivery_jobObj_jobId_edit"
									name="delivery.jobObj.jobId" class="form-control">
								</select>
							</div>
						</div>
						<div class="form-group">
							<label for="delivery_userObj_user_name_edit"
								class="col-md-3 text-right">应聘人:</label>
							<div class="col-md-9">
								<select id="delivery_userObj_user_name_edit"
									name="delivery.userObj.user_name" class="form-control">
								</select>
							</div>
						</div>
						<div class="form-group">
							<label for="delivery_deliveryTime_edit"
								class="col-md-3 text-right">投递时间:</label>
							<div class="col-md-9">
								<div
									class="input-group date delivery_deliveryTime_edit col-md-12"
									data-link-field="delivery_deliveryTime_edit">
									<input class="form-control" id="delivery_deliveryTime_edit"
										name="delivery.deliveryTime" size="16" type="text" value=""
										placeholder="请选择投递时间" readonly> <span
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group date delivery_handleTime_edit col-md-12"
									data-link-field="delivery_handleTime_edit">
									<input class="form-control" id="delivery_handleTime_edit"
										name="delivery.handleTime" size="16" type="text" value=""
										placeholder="请选择处理时间" readonly> <span
										class="input-group-addon"><span
										class="glyphicon glyphicon-remove"></span></span> <span
										class="input-group-addon"><span
										class="glyphicon glyphicon-calendar"></span></span>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="delivery_clzt_edit" name="delivery.clzt"
									class="form-control" placeholder="请输入处理状态">
							</div>
						</div>
						<div class="form-group">
							<label for="delivery_tzxx_edit" class="col-md-3 text-right">通知信息:</label>
							<div class="col-md-9">
								<textarea id="delivery_tzxx_edit" name="delivery.tzxx" rows="8"
									class="form-control" placeholder="请输入通知信息"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="delivery_gzpj_edit" class="col-md-3 text-right">工作评价:</label>
							<div class="col-md-9">
								<textarea id="delivery_gzpj_edit" name="delivery.gzpj" rows="8"
									class="form-control" placeholder="请输入工作评价"></textarea>
							</div>
						</div>
					</form>
					<style>
#deliveryEditForm .form-group {
	margin-bottom: 5px;
}
</style>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="ajaxDeliveryModify();">提交</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
