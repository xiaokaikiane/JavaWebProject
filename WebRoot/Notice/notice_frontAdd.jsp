				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation"><a
							href="<%=basePath %>Notice/frontlist">新闻公告列表</a></li>
						<li role="presentation" class="active"><a href="#noticeAdd"
							aria-controls="noticeAdd" role="tab" data-toggle="tab">添加新闻公告</a></li>
					</ul>
					<!-- Tab panes -->
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane" id="noticeList"></div>
						<div role="tabpanel" class="tab-pane active" id="noticeAdd">
							<form class="form-horizontal" name="noticeAddForm"
								id="noticeAddForm" enctype="multipart/form-data" method="post"
								class="mar_t15">
								<div class="form-group">
									<label for="notice_title" class="col-md-2 text-right">标题:</label>
									<div class="col-md-8">
										<input type="text" id="notice_title" name="notice.title"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea name="notice.content" id="notice_content"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<div id="notice_publishDateDiv"
											class="input-group date notice_publishDate col-md-12"
											data-link-field="notice_publishDate">
											<input class="form-control" id="notice_publishDate"
								...
								<div class="form-group">
									<span class="col-md-2""></span> <span
										onclick="ajaxNoticeAdd();"
										class="btn btn-primary bottom5 top5">添加</span>
								</div>
							</form>
							<style>
#noticeAddForm .form-group {
	margin: 10px;
}
</style>
						</div>
