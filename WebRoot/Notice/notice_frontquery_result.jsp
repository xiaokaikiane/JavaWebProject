...
<body style="margin-top: 70px;">
	<div class="container">
		...
		<div class="row">
				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a
							href="#noticeListPanel" aria-controls="noticeListPanel"
							role="tab" data-toggle="tab">新闻公告列表</a></li>
						<li role="presentation"><a
							href="<%=basePath %>Notice/notice_frontAdd.jsp"
							style="display: none;">添加新闻公告</a></li>
					</ul>
					<!-- Tab panes -->
										...
										<table class="table table-condensed table-hover">
 										...
 										%>
											<tr>
												...
												<td><a
													href="<%=basePath  %>Notice/<%=notice.getNoticeId() %>/frontshow"><i
														class="fa fa-info"></i>&nbsp;查看</a>&nbsp; <a href="#"
													onclick="noticeEdit('<%=notice.getNoticeId() %>');"
													style="display: none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
													<a href="#"
													onclick="noticeDelete('<%=notice.getNoticeId() %>');"
			...
			<div class="col-md-3 wow fadeInRight">
				...
				<form name="noticeQueryForm" id="noticeQueryForm"
					action="<%=basePath %>Notice/frontlist" class="mar_t15"
					method="post">
					...
					<div class="form-group">
						<label for="publishDate">发布时间:</label> <input type="text"
							id="publishDate" name="publishDate" class="form-control"
							placeholder="请选择发布时间" value="<%=publishDate %>"
	...
	<div id="noticeEditDialog" class="modal fade" tabindex="-1"
		role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-edit"></i>&nbsp;新闻公告信息编辑
					</h4>
				</div>
				<div class="modal-body" style="height: 450px; overflow: scroll;">
					<form class="form-horizontal" name="noticeEditForm"
						id="noticeEditForm" enctype="multipart/form-data" method="post"
						class="mar_t15">
						<div class="form-group">
							<label for="notice_noticeId_edit" class="col-md-3 text-right">公告id:</label>
							<div class="col-md-9">
								<input type="text" id="notice_noticeId_edit"
									name="notice.noticeId" class="form-control"
									placeholder="请输入公告id" readOnly>
							</div>
						</div>
						<div class="form-group">
							<label for="notice_title_edit" class="col-md-3 text-right">标题:</label>
							<div class="col-md-9">
								<input type="text" id="notice_title_edit" name="notice.title"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<textarea name="notice.content" id="notice_content_edit"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group date notice_publishDate_edit col-md-12"
									data-link-field="notice_publishDate_edit">
									<input class="form-control" id="notice_publishDate_edit"
										name="notice.publishDate" size="16" type="text" value=""
	...
	margin-bottom: 5px;
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="ajaxNoticeModify();">提交</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
